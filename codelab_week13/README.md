...
![shared preferences](img/Praktikum%204_SharedPreferences.jpg)
...
![try reset](img/Praktikum%204_SharedPreferences%20try%20reset.jpg)
...
![path provider](img/Praktikum%205_Path%20Provider.jpg)
...
```dart
![akses file system direktori](img/Praktikum%206_akses%20file%20system%20direktori.jpg)
```
...
![stored value](img/Praktikum%207_stored%20value.jpg)
