...
<h3 align="center">Pemrograman Asynchronous di Flutter</h3>
...
class _FuturePageState extends State<FuturePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Back from the Future - Cakra')),
      body: Center(
        child: Column(
          children: [
            const Spacer(),
...
- Link: https://www.google.co.id/books/edition/Mein_Kampf/Q5mJEAAAQBAJ?hl=id&gbpv=0

- Kode unik: `Q5mJEAAAQBAJ`
- Di dalam method getData() pada main.dart, ganti ID buku yang ada `Q5mJEAAAQBAJ` dengan ID buku yang baru.
...
- Hasil google apis https://www.googleapis.com/books/v1/volumes/Q5mJEAAAQBAJ:

![alt](./img/soal2_praktikum1.png)
